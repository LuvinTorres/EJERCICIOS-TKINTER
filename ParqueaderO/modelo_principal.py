...
titulo_label.config(bg="#2C3E50", font=("Times New Roman", 30), fg="#FFFFFF")
titulo_label.pack()

seccion1 = ventana.Frame(obj_ventana, bg="#2C3E50")
seccion1.pack()

titulo_seccion1 = ventana.Label(seccion1, text="    Datos de usuario   ")
titulo_seccion1.config(bg="#2C3E50", font=("Times New Roman", 20), fg="#ECF0F1")
titulo_seccion1.pack()

#-----------------------------------------------------------------------
label_nombre = ventana.Label(seccion1, text="Digite el nombre:" )
label_nombre.config(bg="#2C3E50", font=("Times New Roman", 13), fg="#ECF0F1")
label_nombre.pack()
...
label_cedula.config(bg="#2C3E50", font=("Times New Roman", 13), fg="#ECF0F1")
label_cedula.pack()
...
label_tipo_cliente.config(bg="#2C3E50", font=("Times New Roman", 13), fg="#ECF0F1")
...
label_placa.config(bg="#2C3E50", font=("Times New Roman", 13), fg="#ECF0F1")
label_placa.pack()
...
label_marca.config(bg="#2C3E50", font=("Times New Roman", 13), fg="#ECF0F1")
label_marca.pack()
...
label_color.config(bg="#2C3E50", font=("Times New Roman", 13), fg="#ECF0F1")
label_color.pack()
...
label_hora.config(bg="#2C3E50", font=("Times New Roman", 13), fg="#ECF0F1")
label_hora.pack()
